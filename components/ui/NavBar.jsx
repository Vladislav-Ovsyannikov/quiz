...
module.exports = function Navbar({ scores }) {
  return (
    <div className="navbar">
      <div className="select"><a href="/">Главная</a></div>
      <div className="select"><a href="/scores-table">Таблица результатов</a></div>
      <div className="select hidden"><a href="/auth/sign-up">Регистрация</a></div>
